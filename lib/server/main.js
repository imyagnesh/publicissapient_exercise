...
const nodeStats = _path.default.resolve(process.cwd(), 'public/dist/node/loadable-stats.json');

const webStats = _path.default.resolve(process.cwd(), 'public/dist/web/loadable-stats.json');
