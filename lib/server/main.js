...
const nodeStats = _path.default.resolve('../../public/dist/node/loadable-stats.json');

const webStats = _path.default.resolve('../../public/dist/web/loadable-stats.json'); // app.get('/sw.js', (req, res) => {
...
app.get('*', (req, res) => {
  ...
  console.warn(webExtractor.getScriptTags()); // res.set('content-type', 'text/html');
